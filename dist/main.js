        ...
        const removeButton = document.createElement("button");
            ...
            function populateDomElements() {
                ...
                detailsButton.onclick = (e) => {
                    ...
                    _toDoObjectDetailsModalBox_js__WEBPACK_IMPORTED_MODULE_4__.toDoObjectDetailsModalBox.setToDoObjectDetailsModalBox(toDoObject,e);
                ...
                removeButton.addEventListener('click',  _projectController_js__WEBPACK_IMPORTED_MODULE_1__.projectController.removeToDoTaskFromProject);
...
if(!window.localStorage.getItem('user')){
    ...
    _projectController_js__WEBPACK_IMPORTED_MODULE_3__.projectController.storeMyProjects();
}
else{
    let data = JSON.parse(window.localStorage.getItem('user'));
    _projectController_js__WEBPACK_IMPORTED_MODULE_3__.projectController.populateAllProjectsArr(data);
    console.table(_projectController_js__WEBPACK_IMPORTED_MODULE_3__.projectController.getAllProjects());
}


                                   
//Bunlar ayrı bir yere taşınabilir
document.querySelector("#home-button").addEventListener('click', _render_js__WEBPACK_IMPORTED_MODULE_7__.render.renderHomePageToDoList);
...
const popupForm = (()=> {
    ...
    function createEditToDoTaskDetailsPopup(e){
        ...
        let parsed = (0,date_fns_parse__WEBPACK_IMPORTED_MODULE_4__["default"])(toDoDate, 'MM/dd/yyyy', new Date());
    ...
    function createFormDataForExistingToDoObject(e){
        ...
        e.preventDefault();
        const formdata = new FormData(e.target);
        _editToDoObjectForm_js__WEBPACK_IMPORTED_MODULE_2__.editToDoObjectDetailsForm.editToDoObject(e.target.toDoObject,e.target.taskIndex, formdata);
    }
...
const projectController = (() => {
    ...
    // const removeToDoTaskFromProjectForEditButton = (projectName, indexOfTask) => {
    //     const indexOfProject = findIndexOfProject(projectName);
    //     allProjects[indexOfProject].toDoObjects.splice(indexOfTask,1);
    ...
    const renderToDoList = () => {
        ...
        switch(currentProject){
            ...
            default:
                ...
                addTaskButton.onclick = () => _popupForm_js__WEBPACK_IMPORTED_MODULE_4__.popupForm.createPopupFormDomElements();
                return;
        }
...
function createAndPushNewToDoTask(formdata) {
  ...
  let date1 = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_7__["default"])(date, 'MM/dd/yyyy');
  ...
  const parsed = JSON.parse(newToDoObject);       
   ...
   let currentProjectIndex = _projectController_js__WEBPACK_IMPORTED_MODULE_2__.projectController.findIndexOfProject(currentProjectName);
    let allProjects  = _projectController_js__WEBPACK_IMPORTED_MODULE_2__.projectController.getAllProjects();
